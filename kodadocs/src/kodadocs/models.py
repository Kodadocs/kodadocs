...
class SessionConfig(BaseModel):
    ...
    skip_ai: bool = False
    blur_pii: bool = True
    license_key: Optional[str] = Field(default=None, pattern=LICENSE_KEY_PATTERN, description="Pro license key (format: kd_pro_*)")
...
class RunManifest(BaseModel):
    ...
    route_metadata: Dict[str, Dict[str, Any]] = Field(default_factory=dict)  # route -> {dynamic, type, visibility}
    ...
    dom_elements: Dict[str, Any] = Field(default_factory=dict) # route -> list of elements or legacy tree
    annotated_elements: Dict[str, List[Dict[str, Any]]] = Field(default_factory=dict) # route -> elements
    page_descriptions: Dict[str, str] = Field(default_factory=dict) # route -> description
    pii_regions: Dict[str, List[Dict[str, Any]]] = Field(default_factory=dict)  # route -> list of {x, y, width, height}
